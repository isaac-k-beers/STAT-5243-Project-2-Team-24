...
Make sure the required packages are installed: shiny, DT, dplyr, tidyr
Click Run App or run in the console:
shiny::runApp()
Upload a dataset or select a built-in example dataset
Navigate to the Data Cleaning and Preprocessing section
Choose the desired cleaning and preprocessing operations
Review the updated summaries and preview table
